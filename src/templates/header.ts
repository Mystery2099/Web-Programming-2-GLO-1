...
<aside class="sidebar">
	...
	<ul class="nav-links">
		...
		<li>
			<a href="/holidays" data-page="holidays" class="nav-link ${currentPage === 'holidays' ? 'active' : ''}">
				<i data-lucide="calendar-days" aria-hidden="true"></i> Holidays
			</a>
		</li>
		<li>
			<a href="/profile" data-page="profile" class="nav-link ${currentPage === 'profile' ? 'active' : ''}">
				<i data-lucide="compass" aria-hidden="true"></i> My Journey
			</a>
		</li>
		<li>
			<a href="/plans" data-page="plans" class="nav-link ${currentPage === 'plans' ? 'active' : ''}">
				<i data-lucide="layout-list" aria-hidden="true"></i> My Plans
			</a>
		</li>
		<li>
			<a href="/tips" data-page="tips" class="nav-link ${currentPage === 'tips' ? 'active' : ''}">
				<i data-lucide="lightbulb" aria-hidden="true"></i> Tips
			</a>
		</li>
		<li>
			<a href="/settings" data-page="settings" class="nav-link ${currentPage === 'settings' ? 'active' : ''}">
