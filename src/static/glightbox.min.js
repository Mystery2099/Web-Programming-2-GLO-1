!(function (e, t) {
	...
	var q = i(
			function t(i, n) {
				...
				if (
					(e(this, t), (this.img = i), (this.slide = n), (this.onclose = l), this.img.setZoomEvents)
				)
					return !1;
				((this.active = !1),
					(this.zoomedIn = !1),
								...
								if (
									...
									if (l <= 768) n.querySelector('img');
										...
										var a,
											...
											f =
												null === (a = this.elements[this.index]) || void 0 === a ? void 0 : a.node,
											p = '100vh';
										(f &&
											(p = null !== (h = f.getAttribute('data-height')) && void 0 !== h ? h : p),
											v.setAttribute(
												'style',
